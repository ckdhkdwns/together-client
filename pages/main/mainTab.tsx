        ...
        options={{
          tabBarIcon: ({ focused }) => {
            if (focused) return gradientIcon("home");
              ...
              return <Feather name="home" size={Size} color={UnFocusedColor} />;
          },
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => {
            if (focused) return gradientIcon("user");
              ...
              return <Feather name="user" size={Size} color={UnFocusedColor} />;
          },
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => {
            if (focused) return gradientIcon("settings");
              ...
              return (
                <Feather name="settings" size={Size} color={UnFocusedColor} />
              );
          },
        }}
      />
